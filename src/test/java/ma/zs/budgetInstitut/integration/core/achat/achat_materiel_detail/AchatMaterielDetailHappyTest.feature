Feature: AchatMaterielDetail

  Background:
    #* call read('karate-config.js')
    #* call read('db_cleaner.js')
    * url achatMaterielDetailUrl
    * header Content-Type = 'application/json'

    * def postBody = read('AchatMaterielDetailSave.json')
    * def putBody = read('AchatMaterielDetailUpdate.json')
    * def objectSchema = read('AchatMaterielDetailSchema.json')
