Feature: TypeAchatMateriel

  Background:
    #* call read('karate-config.js')
    #* call read('db_cleaner.js')
    * url typeAchatMaterielUrl
    * header Content-Type = 'application/json'

    * def postBody = read('TypeAchatMaterielSave.json')
    * def putBody = read('TypeAchatMaterielUpdate.json')
    * def objectSchema = read('TypeAchatMaterielSchema.json')
