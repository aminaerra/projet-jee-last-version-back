Feature: ExpressionBesoinDetail

  Background:
    #* call read('karate-config.js')
    #* call read('db_cleaner.js')
    * url expressionBesoinDetailUrl
    * header Content-Type = 'application/json'

    * def postBody = read('ExpressionBesoinDetailSave.json')
    * def putBody = read('ExpressionBesoinDetailUpdate.json')
    * def objectSchema = read('ExpressionBesoinDetailSchema.json')
