...
import ma.zs.budgetInstitut.zynerator.security.bean.*;
import ma.zs.budgetInstitut.zynerator.security.common.AuthoritiesConstants;
import ma.zs.budgetInstitut.zynerator.security.service.facade.*;
...
public class BudgetInstitutApplication {
    ...
    public static void main(String[] args) {
        ctx = SpringApplication.run(BudgetInstitutApplication.class, args);
    }
    ...
    public CommandLineRunner demo(UserService userService, RoleService roleService, ModelPermissionService modelPermissionService, ActionPermissionService actionPermissionService, ModelPermissionUserService modelPermissionUserService) {
        return (args) -> {
            if (true) {
                ...
                roleForAdmin.setCreatedAt(LocalDateTime.now());
                roleService.create(roleForEmploye);
