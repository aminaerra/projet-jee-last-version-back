package ma.zs.budgetInstitut.bean.core.achat;
...
public class TypeAchatMateriel   extends AuditBusinessObject     {
    ...
    public static final String MARCHE = "achat par marché";
    public static final String BON_DE_COMMANDE = "achat par bon de commande";
    private Long id;
